...
public class DataManager {
    ...
    public List<Book> getEbooks() {
        return books.stream().filter(Book::hasEbook).collect(Collectors.toList());
    }
